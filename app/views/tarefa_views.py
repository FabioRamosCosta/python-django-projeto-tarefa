...
#from gerenciador_tarefas2.app.forms import TarefaForm
from ..forms import TarefaForm
#from gerenciador_tarefas2.app.entidades.tarefas import Tarefa
#from gerenciador_tarefas2.app.services import tarefa_service
...
# o arquivo tarefa_views.py vai renderizar o arquivo HTML que esta localizado  dentro do diretorio de templates no caminho abaixo

#@login_required()
def listar_todas_tarefas(request):
    tarefas = tarefa_service.listar_todas_tarefas(request.user)
    return render(request, 'tarefas/listar_tarefas.html', {"tarefas": tarefas})
